    ...
    <section class="section-1">
        <?php 
            ...
            if (have_posts()) {
                ...
                echo '<div class="jumbotron d-flex align-items-center" style="background-image: url('.$custom_ingresarurl.');height: 250px">';
        ...
        <div class="container">
            ...
            <?php 
                ...
                while (have_posts()):the_post(); {
                        ...
                        echo '<div class="social-buttons" data-aos="fade-up" data-aos-duration="700">';
                        echo '<div class="row">';
                        echo '<div class="col-sm-12">';
                        echo '<div class="inner-text">';
                        echo '<h3>'.get_the_date().' Posted por <span>'.get_the_author().'</span> En : <span><a href="#">'.$categories[0]->name.'</a></span></h3>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
